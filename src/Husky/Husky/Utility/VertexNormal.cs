...
namespace Husky
{
    ...
    class VertexNormalUnpacking
    {
        ...
        /// <summary>
        /// Unpacks Vertex Tangent, BiTangent & Normal from : Modern Warfare 2019, Vanguard
        /// </summary>
        /// <param name="packedQuat">Packed 4 byte Quat</param>
        /// <returns>Resulting Vertex Tangent, BiTangent, Normal</returns>
